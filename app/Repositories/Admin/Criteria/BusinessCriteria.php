...
class BusinessCriteria extends Criteria {
    ...
    public function apply($model, Repository $repository)
    {
        ...
        if(isset($this->conditions['school']) && !empty($this->conditions['school'])){
            $model = $model->where('school', 'like','%' . $this->conditions['school'] . '%');
        }
